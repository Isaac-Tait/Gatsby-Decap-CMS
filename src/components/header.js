                ...
                <nav className="text-xs font-extralight md:text-xl md:font-bold md:uppercase font-">
                    <ul className="flex h-20 pt-8">
                        ...
                        <li className="ml-1 lg:ml-12">
                            <Link to={'/summer-camp'} className="hover:underline md:hover:font-cursive hover:text-indigo-400 text-green-200 bg-yellow-400 hover:bg-transparent px-1 py-1 rounded-xl">Summer Camp</Link>
                        </li>
                        <li className="ml-1 lg:ml-12">
                            <Link to={'/updates'} className="hover:underline md:hover:font-cursive hover:text-indigo-400 text-yellow-400 bg-green-200 hover:bg-transparent px-1 py-1 rounded-xl">Updates</Link>
                        </li>
                        <li className="ml-1 lg:ml-12">
                            <Link to={'/support'} className="hover:underline md:hover:font-cursive hover:text-indigo-400 text-green-200 bg-yellow-400 hover:bg-transparent px-1 py-1 rounded-xl">Support</Link>
                        </li>
                        <li className="ml-1 lg:ml-12">
