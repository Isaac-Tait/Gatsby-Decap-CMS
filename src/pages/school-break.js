    ...
    <div className="bg-gradient-to-r from-yellow-200 to-green-200">
      ...
      <div className="h-screen grid grid-cols-2 max-w-6xl mx-auto">
        ...
        <div className="mr-4 overflow-y-scroll">
          ...
          />
          <p>
            Looking for a great way for your kids to spend their school breaks.
            Then sign them up for one of our amazing day camp options and get
            them outside, discovering new skills, connecting with friends, and
            making new ones, while growing in their confidence. Our school break
            camps are aligned with the Battle Ground School District calender.
            Click on the specific camps for more details.
          </p>
        </div>
      </div>
      <Footer />
