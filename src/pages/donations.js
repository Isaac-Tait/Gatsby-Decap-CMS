    ...
    <div className="bg-gradient-to-b from-yellow-200 to-indigo-200">
      ...
      <div className="max-w-6xl h-screen overflow-y-scroll mx-auto text-xs md:text-base">
        ...
        <p className="my-4">
          ...
          at the time of the fire so they were unharmed, but our vaulting horse
          was in a paddock attached to the barn and was injured. He is being
          treated at Oregon State University and we are hopeful that he will
        ...
        <div className="flex w-full justify-between">
          <img
            ...
            className="rounded-2xl shadow-xl mt-2 w-1/3"
          />
          <img
