      ...
      <div className="h-screen overflow-y-scroll px-1 sm:grid sm:grid-cols-2">
        ...
        <div className="mr-4 overflow-y-scroll">
          ...
          <p>
            ...
            &nbsp;~&nbsp;Paintball Day Camp ~ Campers learn and play the extreme
            sport of Paintball. Campers learn the game's finer points in the
            morning while fine-tuning their skills. Team building activities
            help teach communication skills while we grow our character through
            daily Bible Study. The last three hours of the day are game time
            when it is time to sling paint!
          </p>
          <p className="italic mt-4">
            Extreme uses conventional markers and balls at 290 fps, with
            woodsball being the primary emphasis.
          </p>
          <p className="italic my-4">
            Splat is our low-impact paintball which uses pump markers, a smaller
            ball, max. speed at 130 fps and is played mainly in the Tactical
            Village.
          </p>
          <hr />
          <div className="my-2 ml-2 text-center">
            <p>
              ...
              June 17-21
              <span className="text-green-200 font-bold">&nbsp;SPLAT</span>
            </p>
            <p>
            ...
            <p>
              ...
              July 1-5
              <span className="text-yellow-400 font-bold">&nbsp;EXTREME</span>
            </p>
            <p>
